...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    const scheduleNotifications = async () => {
      ...
      const reminders = [
        {
          title: "24 Hours Reminder",
          body: `Your event "${upcomingEvent.title}" is starting in 24 hours.`,
          time: 24 * 60 * 60 * 1000,
        },
        {
          title: "8 Hours Reminder",
          body: `Your event "${upcomingEvent.title}" is starting in 8 hours.`,
          time: 8 * 60 * 60 * 1000,
        },
        {
          title: "1 Hour Reminder",
          body: `Your event "${upcomingEvent.title}" is starting in 1 hour.`,
          time: 1 * 60 * 60 * 1000,
        },
        {
          title: "20 Minutes Reminder",
          body: `Your event "${upcomingEvent.title}" is starting in 20 minutes.`,
          time: 20 * 60 * 1000,
        },
      ];
